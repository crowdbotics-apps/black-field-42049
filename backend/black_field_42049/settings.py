"""
Django settings for black_field_42049 project.
...
ROOT_URLCONF = 'black_field_42049.urls'
...
WSGI_APPLICATION = 'black_field_42049.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_field_42049 API",
    "DESCRIPTION": "API documentation for black_field_42049 App",
    "VERSION": "v1",
}
